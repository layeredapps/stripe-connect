...
module.exports = {
  after: requireAllInformationSubmitted
}

async function requireAllInformationSubmitted (req, res) {
  ...
  if (registrations && registrations.length) {
    for (const registration of registrations) {
      if (registration.stripeObject.requirements.currently_due.length) {
        res.ended = true
