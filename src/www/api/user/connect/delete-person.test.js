  ...
  describe('exceptions', () => {
    ...
    describe('invalid-account', () => {
      it('ineligible accessing account', async () => {
        ...
        const req = TestHelper.createRequest(`/api/user/connect/delete-person?personid=${user.director.personid}`)
    ...
    describe('invalid-person', () => {
      it('ineligible querystring person is representative', async () => {
        ...
        const req = TestHelper.createRequest(`/api/user/connect/delete-person?personid=${user.representative.personid}`)
        req.account = user.account
        req.session = user.session
        let errorMessage
        try {
