...
describe('/api/administrator/connect/delete-stripe-account', function () {
  ...
  describe('returns', () => {
    it('boolean', async () => {
      ...
      const req = TestHelper.createRequest(`/api/administrator/connect/delete-stripe-account?stripeid=${user.stripeAccount.stripeid}`)
      req.account = administrator.account
      req.session = administrator.session
